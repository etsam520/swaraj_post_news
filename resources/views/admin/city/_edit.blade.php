                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="name_en"
                                        name="name_en"
                                        value="{{ old('name_en', $city->translate('en')?->city_name) }}"
                                    >
                                    <!-- Error Message -->
                                    @error('name_en')
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="name_hi"
                                        name="name_hi"
                                        value="{{ old('name_hi', $city->translate('hi')?->city_name) }}"
                                    >
                                    <!-- Error Message -->
                                    @error('name_hi')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                {{-- <div class="p-4 border mb-4 form-group">
                                    <div>
                                        <label for="City_photo" class="form-label">City Photo</label>
                                        <input
                                            id="City_photo"
                                            type="file"
                                            name="City_photo"
                                            accept="image/jpg, image/jpeg, image/png"
                                            class="@error('City_photo') is-invalid @enderror"
                                        >
                                        <!-- Error Message -->
                                        @error('City_photo')
                                            <span class="text-danger">{{ $message }}</span>

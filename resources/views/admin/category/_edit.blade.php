                    ...
                    <div class="card">
                        ...
                        <form action="{{ route('admin.category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="name_en"
                                        name="name_en"
                                        value="{{ old('name_en', $category->translate('en')?->category_name) }}">
                                    <!-- Error Message -->
                                    @error('name_en')
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="name_hi"
                                        name="name_hi"
                                        value="{{ old('name_hi', $category->translate('hi')?->category_name) }}">
                                    <!-- Error Message -->
                                    @error('name_hi')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="p-4 border mb-4 form-group">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            class="@error('category_photo') is-invalid @enderror"
                                        >
                                        <!-- Error Message -->
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary float-end mb-1 mb-sm-0">Update</button>
                            </div>
                        </form>
                    </div>
                </div>

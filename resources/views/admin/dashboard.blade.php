        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3 d-none">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <p class="text-muted fs-13 mb-0">Today News</p>
                                        <!--p class="text-muted mb-0 mt-2 fs-12">
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select id="timeframe" class="form-select" onchange="updateChart()">
                                                    ...
                                                    <div class="media mt-0 align-items-center">
                                                        ...
                                                        <div class="media-body">
                                                            <div class="d-flex align-items-center">
                                                                <div class="mt-0">
                                                                    <h5 class="mb-1 fs-13 fw-normal text-dark">{{$n->headline}}</h5>
                                                                    <p class="mb-0 fs-12 text-muted">{{Helpers::timeAgo($n->approved_at)}}</p>
                                                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-stretch">
                                                        ...
                                                        <a href="#" class="border br-5 px-2 py-1 d-flex align-items-center justify-content-center" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
...
<script>
    ...
    const datasets = {
        daily: @json($data['visitors']['daily']),
        weekly: @json($data['visitors']['weekly']),
        monthly: @json($data['visitors']['monthly']),
    };
     let chart;

    function createChart(data, label, lableType='daily') {
        if (chart) chart.destroy();

        const labels = chartLableFormatting(data, lableType);
    ...
    function updateChart() {
        ...
        createChart(datasets[type], `${type.charAt(0).toUpperCase() + type.slice(1)} Visitors`, type);
    }

    updateChart();

    function chartLableFormatting(data, type){
        console.log(type);
        if (type === 'weekly') {
            labels = data.map(item => {
                const year = String(item.label).slice(0, 4);
                const week = String(item.label).slice(4);
            ...
            labels = data.map(item => item.label); // daily
        }
        return labels;
    }
</script>

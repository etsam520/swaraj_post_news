                        ...
                        <form action="{{ route('admin.ads.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" value="{{ old('title') }}" placeholder="Enter ad title">
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('link') is-invalid @enderror" name="link" id="link" value="{{ old('link') }}" placeholder="e.g., https://www.example.com/ad-page">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" rows="5" placeholder="Enter a detailed description or content for the ad.">{{ old('description') }}</textarea>
                                ...
                                {{-- City field remains hidden as per original code --}}
                                <div class="form-group d-none">
                                    ...
                                    <select class="form-control select2 form-select @error('city') is-invalid @enderror" name="city" id="city" data-placeholder="Select">
                                        ...
                                        @foreach ([] as $city) {{-- Assuming $cities is passed to the view if this becomes visible --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mt-2" id="image-preview-container" style="display: none;">
                                        <img id="cover-image-preview" src="#" alt="Cover Image Preview" style="max-width: 200px; height: auto; border: 1px solid #ddd; padding: 5px;">
                                    </div>
                                </div>

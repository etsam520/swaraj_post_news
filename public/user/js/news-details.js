...
const renderNewsDetails = (data) => {
    ...
    console.log(news);
    const translation = news.translations.find(t => t.locale === getLocale()) || news.translations[0];
    const videoLink = generateYoutubeEmbedUrl(getYoutubeVideoId(data.video_link) || '');

    const mainContainer = document.getElementById('news-detail-main');
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-10 col-lg-8 px-lg-3 px-0">
                        <div class="news-detail-container">
                            ...
                            <img src="${S3_Path + news.image}" alt="News Image"
                                class="news-detail-image">
                            <div class="news-detail-title" id="news-detail-title">
                               ${translation.headline}                       
                            </div>
                            <div class="news-detail-meta">
                                By <a href="javascript:void(0)">${news?.creator_name || 'Swaraj Post'}</a>
                                <span>Published : ${timeAgo(news?.publish_at || news?.created_at)}</span>
                            </div>
                            ...
                            `<div class="news-detail-video">
                                <div class="news-detail-video-container">
                                    <div class="news-detail-video-embed">
                                    <iframe id="videoIframe" width="100%" height="500" src="${videoLink}" frameborder="0" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>` : ''
                            }
                            ...
                            <div class="news-detail-nav d-lg-flex justify-content-between mt-4 align-items-center"
                                ...
                                ${
                                    ...
                                    ((data) => {
                                        ...
                                        return `
                                        <div class="news-next">
                                            <a href="${NEWS_PATH + next_translation.slug}"
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        ...
                                                        ${next_translation.headline}
                                                    </div>
                                                </div>
                                                <img src="${S3_Path + nextNews.image}"
                                                    alt=""
                    ...
                    ${
                        ((data) => {
                        if (data?.relatedNews != null) {
                            const relatedNews = data.relatedNews;
                            console.log(relatedNews);

                            return `
                            <div class="col-lg-4 px-lg-3 px-0">
                                <div class="news-list-sidebar"
                                    ...
                                    <h5 style="font-weight:700;margin-bottom:18px;">Related News</h5>
                                    <ul class="list-unstyled" style="margin:0;padding:0;">
                                    ${relatedNews.map((r_news, index) => {
                                        if (index > 6) return ``;
                                        const related_translation = r_news.translations.find(t => t.locale === getLocale()) || r_news.translations[0];
                                        return `
                                        <li style="margin-bottom:18px;display:flex;gap:12px;align-items:flex-start;">
                                            <img src="${S3_Path + r_news.image}"
                                                alt=""
                                                style="width:56px;height:42px;object-fit:cover;border-radius:6px;box-shadow:0 1px 6px rgba(0,0,0,0.06);flex-shrink:0;">
                                            <div>
                                                <a href="${NEWS_PATH + related_translation.slug}"
                                                    style="font-weight:600;color:#222;text-decoration:none;">
                                                    ${related_translation.headline}
                                                </a>
                                                <div style="font-size:0.95rem;color:#888;">
                                                    ${timeAgo(r_news.publish_at)}
                                                </div>
                                            </div>
                                        </li>`;
